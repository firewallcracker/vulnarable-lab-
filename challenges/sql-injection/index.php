...
if (isset($_POST['username']) && isset($_POST['password'])) {
    ...
    if (strpos($username, "'") !== false) {
        ...
        if (strpos($username, 'admin') !== false && (strpos($username, '--') !== false || strpos($username, '#') !== false)) {
            $message = "Welcome Admin! Here's your flag: " . $flag;
            $flag_found = true;
        } elseif (strpos($username, "OR") !== false || strpos($username, "or") !== false) {
            $message = "Welcome Admin! Here's your flag: " . $flag;
            $flag_found = true;
        } else {
...
<head>
    ...
    <style>
        ...
        .hint { background: #fff3cd; color: #856404; border: 1px solid #ffeaa7; margin-top: 20px; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <?php if ($message): ?>
            <div class="message <?php echo $flag_found ? 'success' : 'error'; ?>">
